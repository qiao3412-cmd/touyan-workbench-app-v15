# -*- coding: utf-8 -*-
"""
投研工作台 v15 · 今日热点推送 真实数据源（每日 08:30 自动运行）
...
- 流程：全频道实时池(今天真实新闻) -> 政治/经济/科技/社会按分类取 Top1
        -> 军事/文化按弱相关信号从真实池中筛选最相关今日资讯填充
        -> 固定顺序排布 -> 回写 sampleHotNews 与副标题 -> git 提交推送
- 说明：新浪实时滚动的军事/文化类新闻稀少，军事/文化位采用"同日内最相关的真实资讯"填充，
        保证 6 条均为真实来源、真实发布时间；后续可接入专门军事/文化实时源进一步提纯。
- 排版/样式不变；蓝框 time 取信息来源出处原始发布时间(HH:MM)
"""
import json, re, sys, subprocess, datetime, ssl
from collections import Counter
from urllib.request import Request, urlopen

REPO  = r"G:/Workbuddy/publish/touyan-workbench-app-v15"
...
def main():
    ...
    print("PUSHED -> qiao3412-cmd.github.io/touyan-workbench-app-v15")
